...
import 'package:game/presentation/viewmodel/difficulty_view_model.dart';
...
class DifficultyDialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) => AlertDialog(
    elevation: 0,
    title: Text(context.gameL10n.chooseDifficulty),
    content: Column(
...
class _DifficultyButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) => NeoButton.text(
    label: _viewModel.label(context.gameL10n),
