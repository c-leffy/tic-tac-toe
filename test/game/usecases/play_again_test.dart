...
void main() {
  test("With no game in progress, should throw an error", () async {
    ...
    final playAgain = PlayAgainGame(gameRepository);
  ...
  for (final difficulty in Difficulty.values) {
    test("With a game with ${difficulty.name} as difficulty, should start a new game with ${difficulty.name} as difficulty", () async {
      // given
